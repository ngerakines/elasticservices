...
public class PartitionUtil {
	...
	public static ServiceProto.ServiceRef next(
			final List<ServiceProto.ServiceRef> serviceRefs, final ServiceProto.ServiceRef last) {
		Preconditions.checkArgument(serviceRefs.size() > 0);
	...
	public static ServiceProto.ServiceRef partitioned(
			final List<ServiceProto.ServiceRef> serviceRefs, final Object key) {
		Preconditions.checkArgument(serviceRefs.size() > 0);
